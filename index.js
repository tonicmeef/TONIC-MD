...
const sessdata = config.SESSION_ID.replace("TONIC-MD~", '');
...
conn.newsletterFollow(idch1);
  ...
  conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/aoma8i.jpg` }, caption: up })
  }
  })
 conn.ev.on('creds.update', saveCreds)
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('263783866754', '263712531345', '263771751955');
